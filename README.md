# 🐾 VetCard - Умный помощник по здоровью питомцев

VetCard — это комплексная платформа для управления здоровьем домашних животных, включающая цифровые медицинские карты, AI-ассистента, напоминания о вакцинации и многое другое.
